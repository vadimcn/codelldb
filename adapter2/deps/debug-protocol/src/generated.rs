...
pub struct EvaluateResponseBody {
    ...
    /// Memory reference to a location appropriate for this result. For pointer type eval results,
    /// this is generally a reference to the memory address contained in the pointer.
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(rename = "memoryReference")]
...
pub struct Scope {
    ...
    /// scope is shown with a generic UI.
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(rename = "presentationHint")]
